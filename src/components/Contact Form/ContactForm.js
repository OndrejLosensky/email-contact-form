    ...
    return (
        <div>
            ...
            <div className="flex items-center justify-center">
                <div className="bg-gray-100 p-6 rounded-[30px] shadow-2xl duration-300 w-[70%] h-[60%] mt-2 ">
                    ...
                    <form>
                        <div>
                            ...
                            <input type="text" id="name" className="w-full border border-gray-300 rounded px-3 py-2 mb-4 hover:border-black " placeholder="Vaše jméno" />
                        </div>

                        <div>
                            <label htmlFor="email" className="block text-gray-700 font-medium">E-mail</label>
                            <input type="email" id="email" className="w-full border border-gray-300 rounded px-3 py-2 mb-4 hover:border-black" placeholder="Váš e-mail"/>
                        </div>

                        <div>
                            <label htmlFor="message" className="block text-gray-700 font-medium">Zpráva (nepovinná)</label>
                            <textarea id="message" rows="4" className="w-full h-[200px] max-h-[250px] border border-gray-300 rounded px-3 py-2 hover:border-black" placeholder="Vaše zpráva"></textarea>
                        </div>
